...
c=(min0['cgg']+min0['cdd'])*m_in*2+mclkh['cdd']*m_clkh
ton=-c/mclkh['ids']/m_clkh*vth
print('ton:',ton)
# integration time
#c0=min0['cdb']*m_in+mrgnp['cgs']*m_rgnp
c0=min0['cdd']*m_in+mrgnp['cgg']*m_rgnp+mrstn['cdd']*m_rstn
#c1=mrgnp['cdb']*m_rgnp+mrgnn['cdb']*m_rgnn+mbufn['cgs']*m_buf+mbufp['cgs']*m_buf
c1=(mrgnp['cdd']+mrgnp['cgg'])*m_rgnp+(mrgnn['cdd']+mrgnn['cgg'])*m_rgnn+mbufn['cgg']*m_buf+mbufp['cgg']*m_buf+mrstn['cdd']*m_rstn
